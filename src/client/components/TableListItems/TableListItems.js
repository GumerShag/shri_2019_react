...
const TableListItems = ({files = [], currentUrl}) => {
    return (
        ...
        {files.map((file) => (
            <tr key={uuid.v1()} className="data-table-row">
                <td className="data-table-row__cell data-table-row__cell-name">
                ...
                <td className="data-table-row__cell data-table-row__cell-last-commit">
                    <a href='#' className="link text_color-link">d45gcv</a>
                </td>
                <td className="data-table-row__cell data-table-row__cell-commit-message"><span
                    className="text text_color-primary">[ui] make some change</span>
                </td>
                <td className="data-table-row__cell data-table-row__cell-commiter">
                    <a href='#' className="user link text_color-primary text_size-m"><span
                        className="user__first-letter">a</span>nataolyev</a>
                </td>
                <td className="data-table-row__cell data-table-row__cell-updated"><span
