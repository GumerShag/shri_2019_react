    ...
    return (
        <div className="panel-header">
            <div className="panel-header__title">
                <div className="panel-header__info"><span className="text text_size-l">arcadia</span>
                    <span className="icon-plus">
                                     ...
                                     <div className="icon-plus__icon icon-plus__icon icon icon__arrow icon_size-m icon-plus__icon_indent-l_m"></div>
                            </span>
                </div>
            </div>
            ...
            <div className="panel-header__info panel-header__info-indent-t">
                ...
                <a href='#' className="user link text_color-primary text_size-s">
                <span className="user__first-letter">a</span>ntonov</a>
            </div>
        </div>
    )
}
